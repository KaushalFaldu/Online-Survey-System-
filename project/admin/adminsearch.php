...
.usern i{
 ...
 <div class="class1">
  ...
  <div class="container" style="margin-left:19%; margin-top: 4%;">
   <br />
   <h2 align="center">Search Here </h2><br />
   <div class="form-group">
    <div class="input-group">
     <span class="input-group-addon">Search</span>
     <input type="text" name="search_text" id="search_text" placeholder="Write here" class="form-control" />
    </div>
   </div>
   <br />
   <div id="result"></div>
  ...
  <a href="./adminhome.php" class="menu-btn">
    <i class="fas fa-desktop"></i><button style="margin-left:50%;">back</button>
    </a>
 </body>
</html>
