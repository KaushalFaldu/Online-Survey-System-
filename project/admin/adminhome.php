        ...
        <div class="wrapper">
            ...
            <div class="detail">
                <div class="sidebar">
                    <div class="sidebar-menu">
                        ...
                        <li class="item" id="messages">
                            <a href="./adminview.php" class="menu-btn">
                                <i class="fas fa-clone"></i><span>Category<i></i></span>
                            </a>
                            <!-- <div class="sub-menu">
                    ...
                    <footer><p style="color:white;">Developed By: Kaushal Faldu</p></footer>
                </div>
                <form action="../admin/adminindex.php" method="post">
                    <button type="button" class="button">
                        <span class="button__text"> <a
                                ...
                                href="adminindex.php">Create Question for User </span>
                        <ion-icon name=" fas fa-file"></ion-icon>
                        <a href="adminindex.php"><i id="button__icon" class="fas fa-file"></i></a>
                        </span>
                    </button>
