...
{
 $output .= '
 <div class="panel panel-default" style="margin-left: 292px;width: 78%;">
...
function get_reply_comment($con, $parent_id = 0, $marginleft = 0)
{
 ...
 if($count > 0)
 {
  ...
  {
   $output .= '
   <div class="panel_panel-default" style="margin-left:310px; color: #333;background-color: #f5f5f5;border-color: #ddd;">
    <div class="panel-heading">By <b>'.$row["comment_sender_name"].'</b> on <i>'.$row["date"].'</i></div>
    <div class="panel-body">'.$row["comment"].'</div>
    <div class="panel-footer" align="right"><button type="button" class="btn btn-default reply" id="'.$row["comment_id"].'">Reply</button></div>
   </div>
