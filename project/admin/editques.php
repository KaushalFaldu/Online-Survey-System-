<?php 
    ...
    $count1 = mysqli_query($conn,"SELECT COUNT(*) as total FROM admin_que WHERE status=1");
    ...
    $query = " select * from admin_que where status=1 limit $start,$size";
                            ...
                            ?>
                                    ...
                                    <tr>
                                        <td>
							                ...
							                <label class="form-check-label mb-2" for="programming_language_1"><?php echo $OptionA ?></label>
                                            </td>
                                            </tr>  
                                            <tr>      
                                        <td>
                                            <input class="form-check-input" type="radio" name="programming_language" class="programming_language" id="programming_language_2" value="PHP" checked>
							                <label class="form-check-label mb-2" for="programming_language_2"> <?php echo $OptionB ?></label> 
                                        </td>
                                        </tr> 
                                        <tr>
                                        <td>
                                            <input class="form-check-input" type="radio" name="programming_language" class="programming_language" id="programming_language_3" value="PHP" checked>
							                <label class="form-check-label mb-2" for="programming_language_3"> <?php echo $OptionC ?></label> 
                                        </td>
                                        </tr>
                                        <tr>
                                        <td>
                                            <input class="form-check-input" type="radio" name="programming_language" class="programming_language" id="programming_language_4" value="PHP" checked>
							                <label class="form-check-label mb-2" for="programming_language_4"> <?php echo $OptionD ?></label> 
                                        </td>
                                        </tr>
                                        <td style="background-color: rgb(80, 185, 255); border-radius:0.3em; text-align:center"><a href="adminedit.php?GetID=<?php echo $UserID ?>">Edit</a></td>
                                        <td style="background-color: rgb(221, 235, 99); border-radius:0.3em;  text-align:center"><a href="adminupdate.php?Del=<?php echo $UserID ?>">Delete</a></td>
                                    </tr>        
                            <?php 
                                    }  
                                    echo "<table><tr>";
