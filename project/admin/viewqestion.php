<?php 
    ...
    $q = mysqli_query($con, "insert into survey_table(answer,user_id) values('{$answer}','{$user_id}')");
    if($q){
            ...
            <div class="detail">
                <div class="sidebar">
                    <div class="sidebar-menu">
                        ...
                        <li class="item">
                            <a href="../admin/adminhome.php" class="menu-btn">
                                <i class="fas fa-desktop"></i><span>Dashboard</span>
                            </a>
                        </li>
                        <li class="item" id="list">
                            <a href="./viewcopy.php" class="menu-btn">
                        ...
                        <li class="item" id="settings">
                            <a href="../admin/adminsearch.php" class="menu-btn">
                        ...
                        <table class="a2" >
                            ...
                            ?>
                                    ...
                                    <input class="text_1" type="hidden" name="userid" id="userid"  value="<?php echo $UserID ?>">
                                        ...
                                        <td><a href="./adminhome.php" class="menu-btn">
                                            <i></i><button style="margin-left:90%;">back</button>
                                            </a></td>
                                       <td style="background-color: rgb(80, 185, 255); border-radius:0.3em;text-align:center; width:4%"><a href="edit.php?GetID=<?php echo $UserID ?>">
                                                <i class="fas fa-pen"></i><span>
                                             </a> </td>
                                            <td>&nbsp;</td> 
                                         <td style="background-color: rgb(221, 235, 99); border-radius:0.3em; text-align:center; width:4%"><a href="update.php?Del=<?php echo $UserID ?>">
				...
				var graph3 = new Chart(group_chart3, {
					...
					options:options
                            ...
                            <?php 
                                    ...
                                    //     echo "<td %nbsp;>
                                    //     <form method='post' action='./viewcopy.php'>
