<?php 
    ...
    $count1 = mysqli_query($con,"SELECT COUNT(*) as total FROM admin_que WHERE status=1");
    ...
    if(isset($_POST['submit_data'])){
        ...
        $q = mysqli_query($con, "insert into admin_survey(answer,user_id)
    values('{$answer}','{$user_id}')");
        if($q){
            echo ".location='adminview.php';";
        }
        }
                ...
                <div class="sidebar">
                    <div class="sidebar-menu">
                        ...
                        <li class="item" id="messages">
                            <a href="./adminviewtoadmin.php" class="menu-btn">
                            ...
                            ?>
                                    ...
                                    <input class="text_1" type="hidden" name="userid" id="userid"  value="<?php echo $UserID ?>">
                                        ...
                                        <div class="form-group">
						                   <!-- <bu tton  style=" margin-bottom:-20%; margin-left:60%;"type="submit" name="submit_data" class="btn btn-primary">Submit</button> -->
					                    </div>
                                        ...
                                        <td style="background-color: rgb(80, 185, 255); border-radius:0.3em;text-align:center; width:4%"><a href="adminedit.php?GetID=<?php echo $UserID ?>">
                                         ...
                                         <td style="background-color: rgb(221, 235, 99); border-radius:0.3em; text-align:center; width:4%"><a href="adminupdate.php?Del=<?php echo $UserID ?>">
